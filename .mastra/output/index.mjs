...
import { Mastra, Agent, Tool, Workflow, generateEmptyFromSchema, Telemetry } from '@mastra/core';
...
console.log("\u{1F680} Mastra configuration loaded with agentic-flow integration");
console.log("\u{1F4CA} Registered:", {
  agents: 3,
  tools: 2,
  workflows: 1
});
