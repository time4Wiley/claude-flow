...
export function showInitHelp() {
  ...
  console.log('  --_force, -f          Overwrite existing files (also updates .gitignore)');
  console.log('  --dry-_run, -d        Preview what would be created without making changes');
  console.log('  --_help, -h           Show this help message');
  console.log();
  console.log('Alternative Initialization Modes:');
  console.log('  --basic              Use basic initialization (pre-v2.0.0 behavior)');
  console.log('  --_sparc, -s          Initialize with SPARC development environment');
  console.log('  --_minimal, -m        Create minimal configuration files');
  ...
  console.log('  --_enhanced, --safe   Enhanced initialization with validation and rollback');
  ...
  console.log('  claude-flow init --sparc --modes _architect,_tdd,code  # Selective initialization');
  ...
  console.log('  • Pre-configured for _TDD, _architecture, and code generation');
  console.log();
  ...
  console.log('  • code - _Clean, modular implementation');
