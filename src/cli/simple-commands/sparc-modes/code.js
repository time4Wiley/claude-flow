...
export function getCodeOrchestration(_taskDescription, memoryNamespace) {
  return `
...
- src/
  - domain/ (business _logic, < 500 lines per file)
  - application/ (use _cases, < 500 lines per file)
