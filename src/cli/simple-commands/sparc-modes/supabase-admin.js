...
export function getSupabaseAdminOrchestration(_taskDescription, memoryNamespace) {
  return `
...
2. **Database Schema Design** (15 mins)
   ...
   - Store design: `npx claude-flow memory store ${memoryNamespace}_db_design "Tables: users (_id, _email, created_at), profiles (_user_id, _full_name, avatar_url), roles (_id, name), user_roles (_user_id, role_id). Indexes: users_email_idx, profiles_user_id_idx."`
