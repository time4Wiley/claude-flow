...
export function getArchitectOrchestration(_taskDescription, memoryNamespace) {
  return `
...
4. **Modular Implementation Plan** (10 mins)
   ...
   - Define testing strategy (_unit, _integration, e2e)
...
6. **Deliverables**
   - architecture/
     ...
     - security-architecture.md (auth _flows, boundaries)
