...
console.log('Fixing TypeScript type issues in batch 2 files...');

const filePaths = [
  '/workspaces/claude-code-flow/src/hive-mind/core/DatabaseManager.ts',
  '/workspaces/claude-code-flow/src/hive-mind/integration/SwarmOrchestrator.ts',
  '/workspaces/claude-code-flow/src/swarm/direct-executor.ts',
  '/workspaces/claude-code-flow/src/swarm/memory.ts',
  '/workspaces/claude-code-flow/src/core/config.ts'
];
...
const commonFixes = [
  ...
  // Fix function parameters and return types - more careful patterns
  { 
    pattern: /\(([^)]*): any\):/g, 
...
console.log('Batch 2 type fixes completed!');